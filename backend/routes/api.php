...
//$router->get("/layanan/{id}/dokumentasi", LayananController::class, "imageById", [AuthMiddleware::class]);
$router->get("/layanan/{id}/dokumentasi", LayananController::class, "imageById");
